...
@torch.no_grad()
def eval_error(unet, scheduler, latent, noise_all, text_emb_positive, text_emb_negative, t_to_eval, guidance_scale, ts, noise_idxs, text_emb_idxs):
...
if __name__ == "__main__":
    ...
    # msp_5 = 0.4998440146446228  # 0.01 resnet50
    msp_5 = 0.37922099232673645  # 0.01 resnet18
    ...
    for img_name in os.listdir(data_dir):
        ...
        if flag: # 小于msp 需要再分类 这里可能有对的分错 也可能有错的分对
            ...
            for i, index in enumerate(pred5_extend):
                ...
                negative_index = index[:i] + index[i+1:] # 4——2
            ...
            error_1_image = eval_error(unet, scheduler, x0, noise_all, text_emb_positive, text_emb_negative, t_to_eval, guidance_scale, ts, noise_idxs, text_emb_idxs)
