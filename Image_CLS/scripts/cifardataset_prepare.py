...
def cifar100_to_images():
  tar_dir='D:/LCX_DATA/CIFAR/cifar-100-python/cifar-100-python/' #原始数据库目录
  train_root_dir='D:/LCX_DATA/CIFAR/cifar/train/' #图片保存目录
  test_root_dir='D:/LCX_DATA/CIFAR/cifar/test/'
